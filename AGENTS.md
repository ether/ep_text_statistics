# Agent Guide — ep_text_statistics

Reading Ease and Grade Level of a pad.
...
`ep_text_statistics` runs inside Etherpad's test harness. From an etherpad checkout that has installed this plugin via `pnpm run plugins i --path ../ep_text_statistics`:
...
* Server: `eejsBlock_scripts`, `eejsBlock_editbarMenuRight`
* Client: `aceEditEvent`
